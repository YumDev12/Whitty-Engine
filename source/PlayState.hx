...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
      ...
      case 'alley' | 'ballisticAlley':
		...
		kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " " + (storyDifficulty == 2 ? "Hard" : storyDifficulty == 1 ? "Standerd" : "Baby") + (Main.watermarks ? " - WE " + MainMenuState.kadeEngineVer : ""), 16);
